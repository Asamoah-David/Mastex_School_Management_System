...
def process_omr_image(image_path: str, template_config: dict) -> dict:
    """Thin wrapper around the production pipeline (`omr.pipeline.process_omr_scan`)."""
    from .pipeline import process_omr_scan

    return process_omr_scan(image_path, template_config, save_debug=False)
