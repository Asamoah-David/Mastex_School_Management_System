...
urlpatterns = [
    ...
    path("api/check-identifier/", api_check_identifier, name="api_check_identifier"),
    ...
    path('password-reset/admin/', admin_reset_request, name='admin_reset_request'),
    path('admin/reset-requests/', admin_reset_requests, name='admin_reset_requests'),
    path('admin/reset-requests/<int:request_id>/approve/', admin_reset_request_approve, name='admin_reset_request_approve'),
